...
class VariableWithValues : Table() {
    ...
    val variable : com.openmeteo.flatbuffers.forecast.Variable get() = lookupField(4, com.openmeteo.flatbuffers.forecast.Variable(0u) ) { com.openmeteo.flatbuffers.forecast.Variable(bb.getUByte(it + bufferPos)) }

    val unit : com.openmeteo.flatbuffers.Unit get() = lookupField(6, com.openmeteo.flatbuffers.Unit(0u) ) { com.openmeteo.flatbuffers.Unit(bb.getUByte(it + bufferPos)) }
    ...
    val aggregation : com.openmeteo.flatbuffers.Aggregation get() = lookupField(16, com.openmeteo.flatbuffers.Aggregation(0u) ) { com.openmeteo.flatbuffers.Aggregation(bb.getUByte(it + bufferPos)) }
    ...
    companion object {
        ...
        fun createVariableWithValues(builder: FlatBufferBuilder, variable: com.openmeteo.flatbuffers.forecast.Variable, unit: com.openmeteo.flatbuffers.Unit, value: Float, valuesOffset: VectorOffset<Float>, valuesInt64Offset: VectorOffset<Long>, altitude: Short, aggregation: com.openmeteo.flatbuffers.Aggregation, pressureLevel: Short, depth: Short, depthTo: Short, ensembleMember: Short) : Offset<VariableWithValues> {
        ...
        fun addVariable(builder: FlatBufferBuilder, variable: com.openmeteo.flatbuffers.forecast.Variable) = builder.add(0, variable.value, 0u)

        fun addUnit(builder: FlatBufferBuilder, unit: com.openmeteo.flatbuffers.Unit) = builder.add(1, unit.value, 0u)
        ...
        fun addAggregation(builder: FlatBufferBuilder, aggregation: com.openmeteo.flatbuffers.Aggregation) = builder.add(6, aggregation.value, 0u)
